...
import org.sikuli.ide.sikuli_test.UnitTestRunner;
...
//      prompt.prompt(promptText, 500);
  ...
  //</editor-fold>
   ...
   public int getCodePanes(String moduleName){
	   int count=tabPane.getTabCount();

	   for(int i=0;i<count;i++){
		   String title=tabPane.getTitleAt(i);
		   if ((moduleName+".sikuli").equals(title)){
			   return i;
		   }
   ...
   public void autoSelectTab(int index){
